 ...
 * @generated
 */
public class Webapp1PackageImpl extends EPackageImpl implements Webapp1Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see webapp1.Webapp1Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Webapp1PackageImpl() {
		super(eNS_URI, Webapp1Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Webapp1Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Webapp1Package init() {
		if (isInited)
			return (Webapp1Package) EPackage.Registry.INSTANCE.getEPackage(Webapp1Package.eNS_URI);

		// Obtain or create and register package
		Object registeredWebapp1Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Webapp1PackageImpl theWebapp1Package = registeredWebapp1Package instanceof Webapp1PackageImpl
				? (Webapp1PackageImpl) registeredWebapp1Package
				: new Webapp1PackageImpl();

		isInited = true;

		// Create package meta-data objects
		theWebapp1Package.createPackageContents();

		// Initialize created meta-data
		theWebapp1Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theWebapp1Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Webapp1Package.eNS_URI, theWebapp1Package);
		return theWebapp1Package;
	}
	 ...
	 */
	@Override
	public Webapp1Factory getWebapp1Factory() {
		return (Webapp1Factory) getEFactoryInstance();
	}
