 ...
 * </p>
 * <ul>
 *   <li>{@link it.univaq.disim.mde.editor.impl.ContextImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.impl.ContextImpl#isComposed <em>Composed</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.impl.ContextImpl#getNumberOfElements <em>Number Of Elements</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.impl.ContextImpl#getComponents <em>Components</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.impl.ContextImpl#getInteractionPositions <em>Interaction Positions</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.impl.ContextImpl#getEditors <em>Editors</em>}</li>
 * </ul>
 *
 * @generated
 */
