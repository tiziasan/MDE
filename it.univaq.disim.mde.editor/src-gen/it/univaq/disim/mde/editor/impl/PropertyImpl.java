 ...
 * </p>
 * <ul>
 *   <li>{@link it.univaq.disim.mde.editor.impl.PropertyImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.impl.PropertyImpl#isIsCalculated <em>Is Calculated</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.impl.PropertyImpl#getFormula <em>Formula</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyImpl extends NamedElementImpl implements Property {
	...
	protected EClass eStaticClass() {
		return EditorPackage.Literals.PROPERTY;
	}
	...
	public void setDataType(PropertyTypes newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EditorPackage.PROPERTY__DATA_TYPE, oldDataType,
					dataType));
	}
	...
	public void setIsCalculated(boolean newIsCalculated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EditorPackage.PROPERTY__IS_CALCULATED,
					oldIsCalculated, isCalculated));
	}
	...
	public EList<Formula> getFormula() {
		if (formula == null) {
			formula = new EObjectResolvingEList<Formula>(Formula.class, this, EditorPackage.PROPERTY__FORMULA);
		}
		return formula;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EditorPackage.PROPERTY__DATA_TYPE:
			return getDataType();
		case EditorPackage.PROPERTY__IS_CALCULATED:
			return isIsCalculated();
		case EditorPackage.PROPERTY__FORMULA:
			return getFormula();
		}
