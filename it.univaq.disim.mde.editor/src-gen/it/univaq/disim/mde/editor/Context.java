 ...
 * </p>
 * <ul>
 *   <li>{@link it.univaq.disim.mde.editor.Context#getProperties <em>Properties</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.Context#isComposed <em>Composed</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.Context#getNumberOfElements <em>Number Of Elements</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.Context#getComponents <em>Components</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.Context#getInteractionPositions <em>Interaction Positions</em>}</li>
 *   <li>{@link it.univaq.disim.mde.editor.Context#getEditors <em>Editors</em>}</li>
 * </ul>
 *
 * @see it.univaq.disim.mde.editor.EditorPackage#getContext()
 * @model
 * @generated
 */
public interface Context extends NamedElement {
	 ...
	 * @see it.univaq.disim.mde.editor.EditorPackage#getContext_Properties()
	 ...
	 * @see it.univaq.disim.mde.editor.EditorPackage#getContext_Composed()
	...
	/**
	 * Sets the value of the '{@link it.univaq.disim.mde.editor.Context#isComposed <em>Composed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see it.univaq.disim.mde.editor.EditorPackage#getContext_NumberOfElements()
	...
	/**
	 * Sets the value of the '{@link it.univaq.disim.mde.editor.Context#getNumberOfElements <em>Number Of Elements</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see it.univaq.disim.mde.editor.EditorPackage#getContext_Components()
	 * @model
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link it.univaq.disim.mde.editor.InteractionPosition}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Interaction Positions</em>' containment reference list.
	 * @see it.univaq.disim.mde.editor.EditorPackage#getContext_InteractionPositions()
	 ...
	 * @see it.univaq.disim.mde.editor.EditorPackage#getContext_Editors()
	 * @model required="true"
	 * @generated
	 */
