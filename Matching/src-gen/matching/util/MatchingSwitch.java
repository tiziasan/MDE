 ...
 * @generated
 */
public class MatchingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MatchingPackage.METACLASS: {
			...
			if (result == null)
				result = caseNamedElement(metaclass);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MatchingPackage.NAMED_ELEMENT: {
		...
		case MatchingPackage.CONTEXT_SHAPE: {
			ContextShape contextShape = (ContextShape) theEObject;
			T result = caseContextShape(contextShape);
			if (result == null)
				result = caseNamedElement(contextShape);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Context Shape</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Context Shape</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseContextShape(ContextShape object) {
		return null;
	}
