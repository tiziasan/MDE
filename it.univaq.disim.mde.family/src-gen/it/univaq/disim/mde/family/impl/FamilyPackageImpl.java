...
import it.univaq.disim.mde.family.FamilyFactory;
import it.univaq.disim.mde.family.FamilyPackage;
import it.univaq.disim.mde.family.Members;
import it.univaq.disim.mde.family.NamedElement;
import it.univaq.disim.mde.family.Person;
...
public class FamilyPackageImpl extends EPackageImpl implements FamilyPackage {
	 ...
	 * @see it.univaq.disim.mde.family.FamilyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static FamilyPackage init() {
		if (isInited)
			return (FamilyPackage) EPackage.Registry.INSTANCE.getEPackage(FamilyPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredFamilyPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		FamilyPackageImpl theFamilyPackage = registeredFamilyPackage instanceof FamilyPackageImpl
				? (FamilyPackageImpl) registeredFamilyPackage
				: new FamilyPackageImpl();
	 ...
	 */
	@Override
	public EReference getMembers_Person() {
	 ...
	 */
	@Override
	public EAttribute getMembers_HasChild() {
		return (EAttribute) membersEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getFamily_NumberOfComponents() {
	 ...
	 */
	@Override
	public EReference getFamily_Member() {
	 ...
	 */
	@Override
	public EAttribute getFamily_FamilyIncome() {
	...
	public void createPackageContents() {
		...
		createEReference(membersEClass, MEMBERS__PERSON);
		createEAttribute(membersEClass, MEMBERS__HAS_CHILD);
		...
		createEAttribute(familyEClass, FAMILY__NUMBER_OF_COMPONENTS);
		createEReference(familyEClass, FAMILY__MEMBER);
		createEAttribute(familyEClass, FAMILY__FAMILY_INCOME);
	}
	...
	public void initializePackageContents() {
		...
		membersEClass.getESuperTypes().add(this.getNamedElement());
		...
		initEReference(getMembers_Person(), this.getPerson(), null, "person", null, 1, 1, Members.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getMembers_HasChild(), ecorePackage.getEBoolean(), "hasChild", null, 0, 1, Members.class,
		...
		initEAttribute(getPerson_Gender(), ecorePackage.getEString(), "gender", null, 0, 1, Person.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(familyEClass, Family.class, "Family", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFamily_NumberOfComponents(), ecorePackage.getEInt(), "numberOfComponents", null, 0, 1,
				Family.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getFamily_Member(), this.getMembers(), null, "member", null, 0, -1, Family.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getFamily_FamilyIncome(), ecorePackage.getEDouble(), "familyIncome", null, 0, 1, Family.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
