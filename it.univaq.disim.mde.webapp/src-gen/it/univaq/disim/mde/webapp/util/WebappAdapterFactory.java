/**
 */
package it.univaq.disim.mde.webapp.util;
...
public class WebappAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected WebappSwitch<Adapter> modelSwitch = new WebappSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.univaq.disim.mde.webapp.Webpage <em>Webpage</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.univaq.disim.mde.webapp.NamedElement <em>Named Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.univaq.disim.mde.webapp.Entity <em>Entity</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
