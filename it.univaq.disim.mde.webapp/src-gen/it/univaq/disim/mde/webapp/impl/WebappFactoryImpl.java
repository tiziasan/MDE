...
public class WebappFactoryImpl extends EFactoryImpl implements WebappFactory {
	...
	public static WebappFactory init() {
		try {
			WebappFactory theWebappFactory = (WebappFactory) EPackage.Registry.INSTANCE
					.getEFactory(WebappPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case WebappPackage.WEBPAGE:
			return createWebpage();
		case WebappPackage.ENTITY:
			return createEntity();
		default:
